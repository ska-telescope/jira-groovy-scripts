...
from miro_api.models import CardUpdateRequest
...
def colourise(board_id, frame_name, theme, priorityDict, keyDict, teamDict, capDict, goalDict):
    ...
    api = MiroApi('eyJtaXJvLm9yaWdpbiI6ImV1MDEifQ_u_le6eXV6ijktFkE97dJ-4DZQ8E')
                    ...
                    if theme == 'PRIORITY':
                        ...
                        if issuetype is not None:
                            if str(issuetype)[:4] == 'SDR-' or str(issuetype)[:4] == 'SKB-' or str(issuetype)[:5] == 'ROAM-' :
                                ...
                                print("Found Objective "+str(keyDict.get(card_title)))
                                card_style.card_theme = "#2684FF" #2684FF
                                print("Updating card to Blue")
